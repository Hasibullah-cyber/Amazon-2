...
export default function OrderHistoryPage() {
  ...
  if (!user) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-8 flex flex-col items-center justify-center animate-fade-in">
        <div className="bg-white rounded-2xl p-8 shadow-lg max-w-md w-full text-center animate-slide-up">
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-6 animate-slide-up">
          ...
          <select
            ...
            className="border rounded-xl px-3 py-2 bg-white shadow-sm transform transition-transform hover:scale-[1.02] focus:scale-[1.02]"
          >
          ...
          <div className="space-y-6">
            {filteredOrders.map((order, index) => (
              <div 
                ...
                style={{
                  animation: `slide-up 0.5s ease-out ${index * 0.05}s forwards`,
                  opacity: 0,
                  transform: 'translateY(20px)'
                }}
              >
                <Card className="p-6 rounded-2xl overflow-hidden border-0 shadow-md">
                    ...
                    <div className="grid gap-4">
                      {(order.items || []).map((item: any, idx: number) => (
                        <div 
                          ...
                          style={{
                            animation: `fade-in 0.4s ease-out ${idx * 0.1 + 0.2}s forwards`,
                            opacity: 0
                          }}
                        >
